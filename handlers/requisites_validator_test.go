...
func TestAccountValidation(t *testing.T) {
	...
	tests := []struct {
		...
		// Примеры с валидными данными (нужно будет скорректировать по реальным данным)
...
// TestPaymentRequisitesValidation проверяет полную валидацию всех реквизитов вместе
// Использует реальные данные, с которыми были проблемы при валидации
	...
	tests := []struct {
		...
		},
		{
			...
			requisites: PaymentRequisites{
				Recipient:            "ООО Ромашка",
				BankName:             "ПАО Сбербанк",
				AccountNumber:        "40817810099910004313", // изменена последняя цифра
				CorrespondentAccount: "30101810400000000225",
				Bik:                  "044525225",
				Kpp:                  "770501001",
			},
		...
		},
		{
			...
			requisites: PaymentRequisites{
				...
				BankName:             "ПАО Сбербанк",
				AccountNumber:        "40817810099910004312",
				CorrespondentAccount: "30101810400000000226", // изменена последняя цифра
				Bik:                  "044525225",
				Kpp:                  "770501001",
			},
			valid:       false,
		...
		},
		{
			...
			requisites: PaymentRequisites{
				...
				AccountNumber:        "40817810099910004312",
				CorrespondentAccount: "30101810400000000225",
				Bik:                  "044525226", // изменена последняя цифра
				Kpp:                  "770501001",
			},
			valid:       false,
		...
		},
		{
			...
			requisites: PaymentRequisites{
				Recipient:            "ООО Ромашка",
				BankName:             "ПАО Сбербанк",
				AccountNumber:        "4081781009991000431", // 19 цифр вместо 20
				CorrespondentAccount: "30101810400000000225",
				Bik:                  "044525225",
				Kpp:                  "770501001",
			},
		...
		},
		{
			...
			requisites: PaymentRequisites{
				...
				BankName:             "ПАО Сбербанк",
				AccountNumber:        "40817810099910004312",
				CorrespondentAccount: "3010181040000000022", // 19 цифр вместо 20
				Bik:                  "044525225",
				Kpp:                  "770501001",
			},
			valid:       false,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if isValid != tt.valid {
				...
				// Если тест прошел как ожидалось, выводим дополнительную информацию для успешных случаев
				if tt.valid {
